...
public class POJOPractice {
    ...
    public void getUser(){
        Response response=given().
                          ...
                          when().get("/spartans/{id}",699).prettyPeek();
        ...
        assertEquals(699,spartan.getId());
        assertEquals("Jon Snow",spartan.getName());
        assertEquals("Male",spartan.getGender());
        assertEquals(1112223334,spartan.getPhone());
    ...
    @Test
    public void addUser(){
        Spartan spartan=new Spartan("Nigar","Female",1234560789L);
        Gson gson=new Gson();
